...
module.exports = {
    ...
    GetUploadUrlsResponse: GetUploadUrlsResponse,
    RunFinishComponentRequest: RunFinishComponentRequest,
    GetComponentAndVersionsRequest: GetComponentAndVersionsRequest,
    PostPublishComponentResponse: PostPublishComponentResponse,
    RunComponentResponse: RunComponentResponse,
    GetComponentAndVersionsResponse: GetComponentAndVersionsResponse,
    GetInstanceRequest: GetInstanceRequest,
    SaveInstanceResponse: SaveInstanceResponse,
    GetComponentVersionRequest: GetComponentVersionRequest,
    PrePublishComponentRequest: PrePublishComponentRequest,
    GetInstanceResponse: GetInstanceResponse,
    GetComponentVersionResponse: GetComponentVersionResponse,
    GetUploadUrlsRequest: GetUploadUrlsRequest,
    RunComponentRequest: RunComponentRequest,
    RunFinishComponentResponse: RunFinishComponentResponse,
    PrePublishComponentResponse: PrePublishComponentResponse,
    PostPublishComponentRequest: PostPublishComponentRequest,
    SaveInstanceRequest: SaveInstanceRequest,
